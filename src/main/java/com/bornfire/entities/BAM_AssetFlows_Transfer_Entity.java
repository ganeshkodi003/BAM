...
import java.util.Date;
	@Entity
	@Table(name = "FLOW_ASSETS_TRANSFER")
	public class BAM_AssetFlows_Transfer_Entity {
		...
		public BAM_AssetFlows_Transfer_Entity(BigDecimal srl_no, String asset_serial_no, String asset_name,
		...
		public BAM_AssetFlows_Transfer_Entity() {
			super();
