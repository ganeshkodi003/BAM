...
public class WriteOffReport {
	...
	public WriteOffReport(String asset_serial_no, Date report_date, String report_type, String entry_user,
			Date entry_date, String modify_user, Date modify_date, String verify_user, Date verify_date,
			String status) {
		super();
		this.asset_serial_no = asset_serial_no;
		this.report_date = report_date;
